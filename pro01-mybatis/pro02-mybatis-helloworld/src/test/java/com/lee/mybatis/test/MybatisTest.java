...
//        SqlSession sqlSession = sqlSessionFactory.openSession();
        ...
        //方法2：通过sql语句的唯一标识找到sql并执行，唯一标识是namespace.sqlId
//        int result = sqlSession.insert("com.lee.mybatis.mapper.UserMapper.insertUser");
        System.out.println("insertUser结果：" + result);
        //提交事务
//        sqlSession.commit();
        //关闭SqlSession
        sqlSession.close();
