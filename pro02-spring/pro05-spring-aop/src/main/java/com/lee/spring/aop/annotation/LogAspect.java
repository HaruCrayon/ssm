 ...
 * @AfterThrowing：异常通知，在目标对象方法的catch子句中执行 2、切入点表达式：设置在标识通知的注解的value属性中
...
public class LogAspect {
    ...
    @Pointcut("execution(* com.lee.spring.aop.annotation.CalculatorImpl.*(..))")
    public void pointCut() {
    }

    //@Before("execution(public int com.lee.spring.aop.annotation.CalculatorImpl.add(int, int))")
